...
const TOKEN = config_1.default.tokens.telegram.tenthings;
...
class TelegramBot {
    constructor(token) {
        ...
        this.notifyCosmicForce = (msg, keyboard) => __awaiter(this, void 0, void 0, function* () {
            if (keyboard)
                yield this.sendKeyboard(config_1.default.cosmicForceChat, msg, keyboard, 17);
            else
                yield this.sendMessage(config_1.default.cosmicForceChat, msg, 17);
        });
        this.notifyAdmin = (msg) => __awaiter(this, void 0, void 0, function* () {
            yield this.queueMessage(config_1.default.masterChat, msg);
        });
        this.notify = (msg) => __awaiter(this, void 0, void 0, function* () {
            yield this.queueMessage(config_1.default.noticeChannel, msg);
        });
        this.notifyAdmins = (msg, keyboard) => __awaiter(this, void 0, void 0, function* () {
            if (keyboard)
                yield this.sendKeyboard(config_1.default.adminChat, msg, keyboard);
            else
                yield this.queueMessage(config_1.default.adminChat, msg);
        });
        ...
        this.toDomainMessage = (body) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (body.message || body.callback_query) {
                ...
                if (from.id != config_1.default.masterChat && (yield redis_1.default.get("pause")) === "true")
                    return { messageType: main_1.MessageType.Ignore };
