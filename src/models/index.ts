...
import GameRoundModels, { IGameRound } from "./tenthings/gameround";
...
export const GameRound: Model<IGameRound> = GameRoundModels();
...
export const GameRoundBackup: Model<IGameRound> = GameRoundModels("backup");
