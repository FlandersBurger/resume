    ...
    if (/[ !@#$%^&*()_+\-=\[\]{};':"\\|,.<>\/?]/.test(value.charAt(i))) {
      ...
      switch (hints) {
        ...
        case 2:
          ...
          break;
        case 3:
          if (i == 0 || (i > 0 && value.charAt(i - 1) == ' ') || (i < value.length - 1 && value.charAt(i - 1) == ' ') || i == value.length - 1) {
            str += value.charAt(i);
          } else {
            str += '*';
          }
          break;
        case 4:
          if (i == 0 || (i > 0 && value.charAt(i - 1) == ' ') || /[iuo]/.test(value.charAt(i)) || (i < value.length - 1 && value.charAt(i - 1) == ' ') || i == value.length - 1) {
            str += value.charAt(i);
          } else {
            str += '*';
          }
          break;
        case 5:
          if (i == 0 || (i > 0 && value.charAt(i - 1) == ' ') || /[aeiuo]/.test(value.charAt(i)) || (i < value.length - 1 && value.charAt(i - 1) == ' ') || i == value.length - 1) {
            str += value.charAt(i);
          } else {
            str += '*';
          }
          break;
        case 6:
          if (i == 0 || (i > 0 && value.charAt(i - 1) == ' ') || /[aeiuojxqzkhfwyv]/.test(value.charAt(i)) || (i < value.length - 1 && value.charAt(i - 1) == ' ') || i == value.length - 1) {
            str += value.charAt(i);
          } else {
            str += '*';
          }
          break;
        case 7:
          if (i == 0 || (i > 0 && value.charAt(i - 1) == ' ') || /[aeiuojxqzkhfwyvcmpb]/.test(value.charAt(i)) || (i < value.length - 1 && value.charAt(i - 1) == ' ') || i == value.length - 1) {
            str += value.charAt(i);
          } else {
            str += '*';
          }
          break;
        case 8:
          if (i == 0 || (i > 0 && value.charAt(i - 1) == ' ') || /[aeiuojxqzkhfwyvcmpbdg]/.test(value.charAt(i)) || (i < value.length - 1 && value.charAt(i - 1) == ' ') || i == value.length - 1) {
            str += value.charAt(i);
          } else {
            str += '*';
          }
