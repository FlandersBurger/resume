...
const processGuess = async (guess) => {
    ...
    if (guess.match.type === game_1.GameType.MAINGAME) {
        ...
        console.log(`${guess.gameId} (${game.settings.language}) - ${bash_colors_1.default.LIGHT_CYAN}${game.list.name} ${bash_colors_1.default.LIGHT_BLUE}${guess.match.value}${bash_colors_1.default.END} by ${(0, players_1.getPlayerName)(player)}`);
    }
    else if (guess.match.type === game_1.GameType.MINIGAME) {
        await (0, minigame_1.checkMinigame)(game, player, guess);
        console.log(`${guess.gameId} (${game.settings.language}) -  ${bash_colors_1.default.LIGHT_PURPLE}Minigame guess ${bash_colors_1.default.LIGHT_BLUE}${game.minigame.answer}${bash_colors_1.default.END} by ${(0, players_1.getPlayerName)(player)}`);
    }
    else if (guess.match.type === game_1.GameType.TINYGAME) {
        await (0, tinygame_1.checkTinygame)(game, player, guess);
        console.log(`${guess.gameId} (${game.settings.language}) - ${bash_colors_1.default.LIGHT_GRAY}Tinygame guess => ${bash_colors_1.default.LIGHT_BLUE}${game.tinygame.answer}${bash_colors_1.default.END} by ${(0, players_1.getPlayerName)(player)}`);
    }
};
