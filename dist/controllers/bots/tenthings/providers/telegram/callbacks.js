...
const categories_1 = require("@tenthings/categories");
const emojis_1 = __importDefault(require("@tenthings/emojis"));
const bans_1 = require("@tenthings/providers/telegram/bans");
const stats_1 = require("@tenthings/providers/telegram/stats");
const cache_1 = require("@tenthings/cache");
    ...
    switch (callbackQuery.type) {
        ...
        case TelegramCallbackDataType.Pick:
            if (game.chat_id === parseInt(process.env.ADMIN_CHAT || "")) {
                ...
                if (player.pickedLists.find((pickedListId) => pickedListId.toString() === callbackQuery.data)) {
                    player.infractions++;
                    player.save();
                    return telegram_1.default.queueMessage(game.telegramChannel, (0, i18n_1.default)(game.settings.language, "warnings.alreadyRequested", {
