...
exports.mongoDBs = [
  Object.assign(
    { name: "backup", url: process.env.MONGO_BACKUP_URL },
  ...
  Object.assign(
    { name: "master", url: process.env.MONGO_URL },
...
exports.mongoDBs.forEach((db) =>
  __awaiter(void 0, void 0, void 0, function* () {
    connect(db);
    if (db.tunnel) {
      yield (0, tunnel_ssh_1.createTunnel)({ autoClose: true }, { host: "127.0.0.1", port: 27017 }, db.tunnel, {
        dstPort: 27017,
      });
