...
class TelegramBot {
  constructor(token) {
    ...
    this.deleteMessage = (channel, message_id) =>
      __awaiter(this, void 0, void 0, function* () {
    ...
    this.kick = (channel, userId, minutes) =>
      __awaiter(this, void 0, void 0, function* () {
    ...
    this.notifyCosmicForce = (msg, keyboard) =>
      __awaiter(this, void 0, void 0, function* () {
        if (keyboard) yield this.sendKeyboard(parseInt(process.env.COSMIC_FORCE_CHAT || ""), msg, keyboard, 17);
        else yield this.sendMessage(parseInt(process.env.COSMIC_FORCE_CHAT || ""), msg, 17);
      });
    ...
    this.notifyAdmins = (msg, keyboard) =>
      __awaiter(this, void 0, void 0, function* () {
        if (keyboard) yield this.sendKeyboard(parseInt(process.env.ADMIN_CHAT || ""), msg, keyboard);
        else yield this.queueMessage(parseInt(process.env.ADMIN_CHAT || ""), msg);
      });
    this.broadcast = (channels, message) =>
      __awaiter(this, void 0, void 0, function* () {
    ...
    this.getChatMember = (channel, userId) =>
      __awaiter(this, void 0, void 0, function* () {
    ...
    this.checkAdmin = (channel, userId) =>
      __awaiter(this, void 0, void 0, function* () {
        const url = `${this.baseUrl}/getChatMember?chat_id=${channel}&user_id=${userId}`;
        try {
          const response = yield axios_1.default.get(url);
    ...
    this.sendKeyboard = (channel, message, keyboard, topic) =>
      __awaiter(this, void 0, void 0, function* () {
    ...
    this.sendAnimation = (channel, animation) =>
      __awaiter(this, void 0, void 0, function* () {
    ...
    this.editKeyboard = (channel, message_id, keyboard) =>
      __awaiter(this, void 0, void 0, function* () {
    ...
    this.answerCallback = (callback_query_id, text) =>
      __awaiter(this, void 0, void 0, function* () {
    ...
    this.setCommands = (channel, language) =>
      __awaiter(this, void 0, void 0, function* () {
        const commands = [
          "list",
          "hint",
    ...
    this.toDomainUser = (from) =>
      Object.assign(Object.assign({}, from), {
        name: (0, string_helpers_1.maskUrls)(
          from.username ? `@${from.username}` : `${from.first_name} ${from.last_name ? from.last_name : ""}`
        ),
      });
    this.toDomainMessage = (body) =>
      __awaiter(this, void 0, void 0, function* () {
        if (body.object === "page") {
