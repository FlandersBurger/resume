...
const spam_1 = require("@root/controllers/bots/tenthings/providers/telegram/spam");
const telegram_1 = require("@root/controllers/api/tenthings/telegram");
const string_helpers_1 = require("@utils/string-helpers");
const moment_1 = __importDefault(require("moment"));
const commands_1 = require("@root/controllers/bots/tenthings/providers/telegram/commands");
const telegram_2 = require("@root/controllers/bots/tenthings/providers/telegram");
                ...
                if (this.muteReasons.includes(reason)) {
                    ...
                    if (!this.paused) {
                        ...
                        if (timeout > 100)
                            ...
                            console.log(`${channel.chat} - Pausing queue for ${timeout} seconds due to too many requests`);
