...
function Lemmings() {
    ...
    (0, react_1.useEffect)(() => {
        ...
        function makeLemming(initAction) {
            ...
            l.move = () => {
                ...
                ctx.drawImage(lemmingsImage, l.width * column + l.action.start[0], (l.height + 20) * row + l.action.start[1], l.width, l.height, 0, 0, l.width * 2, l.height * 2);
                ctx.restore();
                if (l.action.reverse) {
                    if (l.animation) {
                        l.cycle++;
        ...
        function makeHatch() {
            ...
            h.open = () => {
                ...
                if (started && h.cycle < 9)
                    h.cycle++;
                ctx.drawImage(decorImage, h.width * column + h.action.start[0], h.height * row + h.action.start[1] - 1, h.width, h.height, 0, 0, h.width * 2, h.height * 2);
                ctx.restore();
            };
            return h;
        }
