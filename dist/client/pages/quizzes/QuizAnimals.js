...
function QuizAnimals() {
    const [animals, setAnimals] = (0, react_1.useState)([]);
    (0, react_1.useEffect)(() => {
        (0, quizzes_1.getQuizFiles)("animals").then((files) => {
            const names = files.map(toName);
            setAnimals(files.map((sound) => {
...
exports.default = QuizAnimals;
//# sourceMappingURL=QuizAnimals.js.map