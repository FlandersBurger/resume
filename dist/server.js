...
const quizzes_1 = require("@api/quizzes");
...
const categories_1 = require("@api/tenthings/categories");
...
const stats_1 = require("@api/tenthings/stats");
const search_1 = require("@api/tenthings/search");
const users_1 = require("@api/users");
const telegram_2 = require("@api/tenthings/telegram");
const queue_1 = require("@root/queue");
const telegram_3 = __importDefault(require("./connections/telegram"));
const web_1 = require("@api/tenthings/web");
